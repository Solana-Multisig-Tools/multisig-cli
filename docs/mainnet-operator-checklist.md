...
curl -LO "https://github.com/Solana-Multisig-Tools/msig/releases/download/${MSIG_VERSION}/msig-${MSIG_VERSION}-${MSIG_TARGET}"
curl -LO "https://github.com/Solana-Multisig-Tools/msig/releases/download/${MSIG_VERSION}/msig-${MSIG_VERSION}-${MSIG_TARGET}.sha256"
